...
MenuService::MenuService(CircularList<MenuOption *> &menuOptions,
                         MenuBox *menuBox, Font *font) {
...
void MenuService::initCurrentOption() { currentOption = menuOptions.begin(); }

void MenuService::renderMenu() {
  // Render box
  drawOutlinedRectangle(menuBox->boxSprite, 8, {255, 255, 255, 255});
...
MenuOption *MenuService::getCurrentMenuOption() const { return *currentOption; }
